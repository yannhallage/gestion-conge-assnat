    ...
    const menuSections = [
        {
            ...
            items: [
                ...
                { id: "presence", label: "Présence", icon: <svg width="24" className="text-gray-300" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><g id="m-q/presence"><g id="Frame" clip-path="url(#clip0_2565_5)"><g id="Group"><path id="Vector" d="M15.8 13.9C15.5 13.9 15 13.8 14.4 13.6C12.9 13.1 12.8 11.7 12.8 11.7C13.5 11.2 14.1 10.5 14.7 9.6C15.4 8.5 15.5 6.5 15.5 5.5C15.5 5.2 15.5 5 15.4 4.7C15 2.6 13.2 1 10.9 1C8.6 1 6.8 2.6 6.4 4.7C6.4 4.9 6.3 5.2 6.3 5.5C6.3 6.6 6.4 8.5 7.1 9.6C7.5 10.4 8 11 8.6 11.4C8.6 11.4 8.3 13.2 6.9 13.6L3.7 14.3C2 14.9 2 16.9 2 16.9V20H12.5C12.4 19.7 12.4 19.3 12.4 19C12.4 16.7 13.8 14.7 15.8 13.9Z" fill="currentColor"></path><path id="Vector_2" d="M18 23C20.2091 23 22 21.2091 22 19C22 16.7909 20.2091 15 18 15C15.7909 15 14 16.7909 14 19C14 21.2091 15.7909 23 18 23Z" fill="currentColor"></path></g></g></g><defs><clipPath id="clip0_2565_5"><rect width="20" height="22" fill="white" transform="translate(2 1)"></rect></clipPath></defs></svg> },
            ],
        },
        {
            title: "Congés",
            items: [
                { id: "demander", label: "Demander", icon: <svg width="24" height="24" className="text-gray-300" viewBox="0 0 24 24" fill="currentColor"><path fillRule="evenodd" clipRule="evenodd" d="M18.7402 10.1818L13.8473 5.2806L17.1159 1.99414L22.0098 6.89644L18.7402 10.1818ZM6.90469 22.0173H2.00977V17.114L12.5043 6.56464L17.3992 11.468L6.90469 22.0173Z" fill="currentColor" /></svg> },
                {
                    id: "calendrier",
                    label: "Calendrier",
                    icon: <svg width="24" height="24" className="text-gray-300" viewBox="0 0 24 24" fill="currentColor"><path fillRule="evenodd" clipRule="evenodd" d="M2 22.001V12.145H22.001V22.001H2ZM2 5.216H5.256V2H7.6V5.216H16.879V2H19.223V5.216H22.001V10.235H2V5.216Z" fill="currentColor" /></svg>,
                },
                {
                    id: "demandes",
                    label: "Demandes",
            ...
            items: [
                {
                    ...
                    icon: <svg width="24" height="24" className="text-gray-300" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><g id="m-q/question"><g id="ic_pytanie"><g id="pytanie"><path id="Shape" fill-rule="evenodd" clip-rule="evenodd" d="M2 2V22L5.278 18.9289H21.996V2H2ZM15.741 13.3666H6.558V11.4792H15.741V13.3666ZM17.788 10.0356H6.558V8.14916H17.788V10.0356Z" fill="currentColor"></path></g></g></g></svg>,
                },
                {
                    id: "rapport",
                    label: "Rapport",
