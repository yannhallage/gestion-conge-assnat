      ...
      <div className="flex items-center p-2 border-b border-[#ccc]">
        ...
        >
          <svg
            ...
            className="ui_icon_1z4c4c0lsv lui_icon_1uqg37zrid"
          >
            <g id="a-d/add">
              <path
                id="Union"
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M13 11L13 4L11 4L11 11L4.00001 11L4.00001 13H11L11 20H13L13 13H20L20 11H13Z"
                fill="currentColor"
              ></path>
            </g>
          </svg>
      ...
      <div className="flex items-center p-4 space-x-3 border-[#ccc] text-sm">
        ...
        <div className="flex cursor-pointer items-center bg-[#f6f7f9] border-[#ccc] px-2 py-1">
          ...
          <span className="text-[#ccc]">
            Statut: <span className="font-medium text-[#555]">Actif</span>
          </span>
        </div>
        <button className="text-[#27a082] font-medium cursor-pointer">
          + AJOUTER UN FILTRE
        </button>{" "}
      </div>
    ...
    >
      ...
      >
        <svg
          ...
          aria-describedby="floating-ui-566s223"
        >
          <g id="e-h/edit">
            <path
              id="Subtract"
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M12.0322 6.56778L3 15.6V21H8.4L14.7 14.7L17.4322 11.9678L12.0322 6.56778ZM13.1111 5.48887L18.516 10.884L21 8.4L18.3 5.7L15.6 3L13.1111 5.48887Z"
              fill="currentColor"
            ></path>
          </g>
        </svg>
      ...
      <button
        className="hover:text-[#27a082] cursor-pointer"
        data-tooltip-id="modifier le droit"
        data-tooltip-content="modifie le droit"
        // onClick={() => setIsOpenDelete(true)}
      >
        <svg
          width="18"
          ...
          xmlns="http://www.w3.org/2000/svg"
          className="ui_icon_1z4c4c0lsv"
          aria-describedby="floating-ui-uy5o226"
        >
          <g id="a-d/change-limits">
            <path
              id="Subtract"
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M3 6C3 4.34315 4.34315 3 6 3H18C19.6569 3 21 4.34315 21 6V18C21 19.6569 19.6569 21 18 21H6C4.34315 21 3 19.6569 3 18V6ZM13 6H11V9H8V11H11V14H13V11H16V9H13V6ZM16 18V16H8V18H16Z"
              fill="currentColor"
            ></path>
          </g>
        </svg>
      ...
      >
        ...
        >
          <g id="r-u/role-allmanagers">
            <path
              id="Union"
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M3.5 10.4299C3.5 5.76534 7.29667 2 12 2C16.7033 2 20.5 5.76534 20.5 10.4299C20.5 13.4459 18.8944 16.106 16.4767 17.5859V21.7072C16.4767 21.9132 16.25 22.0631 16.0422 21.9694L12.3967 20.246C12.1322 20.1336 11.8489 20.1336 11.5844 20.246L7.93889 21.9694C7.73111 22.0631 7.50444 21.932 7.50444 21.7072V17.5859C5.10556 16.106 3.5 13.4459 3.5 10.4299ZM6.01222 10.4299C6.01222 13.6894 8.67556 16.3308 11.9622 16.3308C15.23 16.3308 17.8933 13.6894 17.8933 10.4299C17.8933 7.17032 15.2489 4.52896 11.9622 4.52896C8.67556 4.52896 6.01222 7.17032 6.01222 10.4299ZM16.7789 10.4299C16.7789 13.0681 14.6224 15.2068 11.9622 15.2068C9.30206 15.2068 7.14557 13.0681 7.14557 10.4299C7.14557 7.79163 9.30206 5.65293 11.9622 5.65293C14.6224 5.65293 16.7789 7.79163 16.7789 10.4299Z"
              fill="currentColor"
            ></path>
          </g>
        </svg>
      ...
      <button
        className="hover:text-[#27a082] cursor-pointer"
        data-tooltip-id="photo"
        data-tooltip-content="photo"
        // onClick={() => setIsOpenDelete(true)}
      >
        <svg
          width="18"
          ...
          xmlns="http://www.w3.org/2000/svg"
          className="ui_icon_1z4c4c0lsv"
          aria-describedby="floating-ui-3e6i232"
        >
          <g id="m-q/photo">
            <g id="Frame 635848">
              <path
      ...
      <button
        className="hover:text-[#27a082] cursor-pointer"
        data-tooltip-id="parametre"
        data-tooltip-content="parametre"
        // onClick={() => setIsOpenDelete(true)}
      >
        <svg
          width="18"
      ...
      >
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
          className="ui_icon_1z4c4c0lsv"
          aria-describedby="floating-ui-kept238"
        >
          <g id="m-q/notifications">
            <path
              id="Vector"
      ...
      <button
        className="hover:text-[#27a082] cursor-pointer"
        data-tooltip-id="motdepasse"
        data-tooltip-content="réinitialiser le mot de passe"
        // onClick={() => setIsOpenDelete(true)}
      >
        <svg
          width="18"
          ...
          xmlns="http://www.w3.org/2000/svg"
          className="ui_icon_1z4c4c0lsv"
          aria-describedby="floating-ui-ftha244"
        >
          <g id="i-l/key">
            <path
              id="Subtract"
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M9.84865 4.6942C7.24346 7.28662 7.24346 11.4898 9.84865 14.0822C12.4538 16.6746 16.6777 16.6746 19.2829 14.0822C21.8881 11.4898 21.8881 7.28662 19.2829 4.6942C16.6777 2.10179 12.4538 2.10179 9.84865 4.6942ZM17.8314 9.7493C18.4326 9.15105 18.4326 8.1811 17.8314 7.58285L16.38 6.13855C15.7788 5.5403 14.8041 5.5403 14.2029 6.13855C13.6017 6.7368 13.6017 7.70675 14.2029 8.305L15.6543 9.7493C16.2555 10.3476 17.2302 10.3476 17.8314 9.7493Z"
              fill="currentColor"
            ></path>
            <path
              id="Vector 26"
              d="M3.02267 18.6024L11.7764 9L14.9243 12.1325L11.8454 15.1963L11.8684 17.2618L9.79278 17.2389L8.76647 18.2602L8.78948 20.3256L3.75404 20.2701C2.88959 20.2605 2.44183 19.2395 3.02267 18.6024Z"
              fill="currentColor"
            ></path>
          </g>
        </svg>
      ...
      >
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
          className="ui_icon_1z4c4c0lsv"
          aria-describedby="floating-ui-e6hn247"
        >
          <g id="a-d/archive">
            <path id="Vector" d="M22 2H2V6H22V2Z" fill="currentColor"></path>
            <path
              id="Subtract"
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M3 7V20C3 20.5304 3.21071 21.0391 3.58578 21.4142C3.96086 21.7893 4.46957 22 5 22H19C19.5304 22 20.0391 21.7893 20.4142 21.4142C20.7893 21.0391 21 20.5304 21 20V7H3ZM9 10H15V11.5V12H9V11.5V10ZM15 16H9V18H15V16Z"
              fill="currentColor"
            ></path>
          </g>
        </svg>{" "}
