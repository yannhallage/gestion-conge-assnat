...
export default DemanderFeatureAdmin;
        ...
        >
            ...
            <div className="w-full md:w-64 mt-6 md:mt-0 md:ml-6 space-y-3">
                <div>
                    ...
                    <input
                        type="date"
                        className="w-55 border border-[#ccc] p-2 text-sm focus:outline-none focus:ring focus:ring-emerald-200"
                    />
                </div>
                <div>
                ...
                <div>
                    ...
                    <select className="w-55 border border-[#ccc] p-2 text-sm focus:outline-none focus:ring focus:ring-emerald-200">
