...
export default function InteractionRhFeatures() {
    ...
    const { getAllInteractionsRh, deleteInteractionRh } = useRhService();
    ...
    return (
        ...
        >
            ...
            <p className="text-sm text-gray-400 mt-2 max-w-md">
                Il n'y a actuellement aucune interaction RH. Créez votre première interaction pour communiquer avec le personnel.
            </p>
        </motion.div>
    )
}
...
const RecommendedProducts: React.FC<RecommendedProductsProps> = ({ interactions, onDelete }) => {
        ...
        <div className="space-y-4">
            ...
            <div className="grid gap-4">
                {interactions.map((interaction) => (
                    <motion.div
                        key={interaction.id_interaction_rh || interaction.titre}
                        ...
                        <div className="flex items-start justify-between gap-4">
                            <div className="flex-1">
                                <div className="flex items-center gap-3 mb-2">
                                    <h3 className="text-lg font-semibold text-gray-800">{interaction.titre}</h3>
                                </div>
                                ...
                                <div className="flex items-start gap-2 mt-3">
                                    ...
                                    <p className="text-gray-700 leading-relaxed">{interaction.message}</p>
                                </div>
                            </div>

                            <button
                                onClick={() => interaction.id_interaction_rh && onDelete(interaction.id_interaction_rh)}
