...
export default function DrawerAddPersonne({ isOpen, onClose }: DrawerProps) {
    ...
    const tabs = ["Information personnel", "Contact", 'Information congé',"Administration"];
    ...
    const conges = [
        {
            ...
            prises: 5,
            restant: 10,
            dates: ["2025-01-15", "2025-03-20", "2025-05-05", "2025-07-12", "2025-09-01"],
        },
        {
            annee: 2024,
            prises: 8,
            restant: 7,
            dates: ["2024-02-10", "2024-04-22", "2024-06-15", "2024-08-08", "2024-10-01", "2024-11-12", "2024-12-20", "2024-12-24"],
        },
    ];

    return (
        <div className="p-6 bg-white shadow-md rounded-lg w-full">
            <h2 className="text-xl font-semibold mb-4">Informations sur les congés</h2>

            {conges.map((conge, idx) => (
                <div key={idx} className="mb-6 border-b border-gray-200 pb-4 last:border-none">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mb-3">
                        ...
                        <div className="flex-1 bg-yellow-50 p-4 rounded-lg text-center">
                            ...
                            <p className="text-yellow-600 font-bold text-lg">{conge.restant}</p>
                        </div>
                    </div>

                    {/* Liste des dates de congés */}
                    <div className="mt-3">
                        <p className="text-gray-500 text-sm mb-2 font-medium">Dates des congés :</p>
