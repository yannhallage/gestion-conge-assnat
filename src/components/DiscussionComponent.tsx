        ...
        <div className="mt-6 text-sm text-gray-500 relative h-[400px] flex flex-col">
                ...
                {messages.length === 0 ? (
                    ...
                    >
                        <img
                            ...
                            className="w-20 mb-3"
                        />
                        <p>Personne n'a encore commenté cette demande.</p>
                    </motion.div>
                ) : (
            ...
            <div className="mt-3">
                <textarea
                    ...
                    className="w-full border border-gray-300 p-2 text-sm focus:ring-2 focus:ring-[#27a082] focus:outline-none resize-none"
                />
            </div>
            <div className="space-x-1">
                <button
                    className="px-4 py-2 border border-gray-300 text-white bg-[#27a082] cursor-pointer"
                >
                    Envoyer
                </button>
                <button
                    className="px-4 py-2 border border-gray-300 text-gray-2001 cursor-pointer"
                >
                    Annuler
                </button>
            </div>
