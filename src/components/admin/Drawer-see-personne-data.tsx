...
export default function DrawerSeePersonneData({
  isOpen,
  onClose,
}: DrawerProps) {
  ...
  const tabs = ["Primary", "Contact", "Information congé", "Administration"];
      ...
      >
        <header className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div
              className="flex space-x-3 cursor-pointer"
              data-tooltip-id="changer le mot de passe"
              data-tooltip-content="changer le mot de passe"
            >
              <svg
                width="24"
                height="24"
    ...
    <>
      <div className="bg-white space-y-5">
        ...
        <div className="space-y-5">
          {["First Name", "Last Name", "Email", "Gender", "Birthdate"].map(
            (label, i) => (
  ...
  return (
    <>
      <div className="bg-white space-y-5">
        ...
        <div className="space-y-5">
          {["Business email", "Business phone"].map((label, i) => (
            <div key={i} className="flex items-center justify-between gap-6">
              <label className="w-1/3 text-[#abb2b9]">{label}*</label>
              {/* <input
                                type="text"
      ...
      <div className="bg-white space-y-5">
        ...
        <div className="space-y-5">
          {["Personal email", "Personal phone"].map((label, i) => (
            <div key={i} className="flex items-center justify-between gap-6">
              <label className="w-1/3 text-[#abb2b9]">{label}*</label>
              {/* <input
                                type="text"
...
function ToastPersonnalise() {
  return (
    <div className="flex items-center gap-3 bg-white">
      ...
      <span className="text-sm font-medium">Yann Hallage a été invité</span>
    </div>
  );
}
